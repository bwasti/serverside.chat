...
const ESC = "\x1b[";
const RESET = `${ESC}0m`;
const HEADER = `${ESC}48;5;236m${ESC}38;5;255m`;
const FOOTER = `${ESC}48;5;238m${ESC}38;5;252m`;
const GUTTER = `${ESC}48;5;234m${ESC}38;5;244m`;
const TEXT = `${ESC}48;5;233m${ESC}38;5;252m`;
const CYAN = `${ESC}38;5;45m`;
const GREEN = `${ESC}38;5;82m`;
const YELLOW = `${ESC}38;5;220m`;
const MAGENTA = `${ESC}38;5;213m`;
const COMMENT = `${ESC}38;5;244m`;
